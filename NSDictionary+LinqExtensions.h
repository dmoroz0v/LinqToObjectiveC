...
typedef id (^LINQKeyValueSelector)(KeyType key, ObjectType value);

typedef BOOL (^LINQKeyValueCondition)(KeyType key, ObjectType value);
 ...
 */
- (NSDictionary<KeyType, ObjectType> *)linq_where:(LINQKeyValueCondition)predicate;
 ...
 */
- (NSDictionary<KeyType, id> *)linq_select:(LINQKeyValueSelector)selector;
